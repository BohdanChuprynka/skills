...
export function usage() {
  return [
    'Usage:',
    '  session-continue <session-id> -- <task>                 (normal: source auto-detected)',
    '  session-continue from <source> <session-id> -- <task>   (escape hatch: pin source)',
    '  session-continue --from <source> --id <session-id> -- <task>',
    '',
    'Examples:',
    '  session-continue abc123 -- finish the refactor',
    '  session-continue session id: abc123 -- keep going',
    '  session-continue --from <source> --id abc123 -- keep going',
    '',
    'When the source is omitted, the session id is located on disk across every',
    'configured Claude account dir and the Codex sessions dir. The owning dir is',
    'then exported for continues before the handoff is generated.',
    '',
